...
CREATE INDEX tipoEquipoIdFk ON equipo(tipoEquipoIdFk);
CREATE INDEX servicioIdFk ON equipo(servicioIdFk);
CREATE INDEX sedeIdFk ON equipo(sedeIdFk);
CREATE INDEX responsableIdFk ON equipo(responsableIdFk);
...
CREATE INDEX equipoIdFk ON documento(equipoIdFk);
CREATE INDEX tipoDocumntoIdFk ON documento(tipoDocumntoIdFk);
...
CREATE INDEX datosTecnicosIdFk ON hojavida(datosTecnicosIdFk);
CREATE INDEX equipoIdFk_hv ON hojavida(equipoIdFk);
CREATE INDEX fabricanteIdFk ON hojavida(fabricanteIdFk);
CREATE INDEX proveedorIdFk ON hojavida(proveedorIdFk);
...
CREATE INDEX equipoIdFk_pam ON planactividadmetrologica(equipoIdFk);
...
CREATE INDEX equipoIdFk_pm ON planmantenimiento(equipoIdFk);
...
CREATE INDEX tipoEquipoIdFk_pp ON protocolopreventivo(tipoEquipoIdFk);
...
CREATE INDEX equipoIdFk_am ON actividadmetrologica(equipoIdFk);
CREATE INDEX usuarioIdFk_am ON actividadmetrologica(usuarioIdFk);
...
CREATE INDEX equipoIdFk_rep ON reporte(equipoIdFk);
CREATE INDEX servicioIdFk_rep ON reporte(servicioIdFk);
CREATE INDEX usuarioIdFk_rep ON reporte(usuarioIdFk);
...
CREATE INDEX protocoloPreventivoIdFk ON cumpliminetoprotocolopreventivo(protocoloPreventivoIdFk);
CREATE INDEX reporteIdFk ON cumpliminetoprotocolopreventivo(reporteIdFk);
...
CREATE INDEX idx_hospital_estado ON hospital(estado);
CREATE INDEX idx_baja_hospital ON baja(id_hospital_fk);
CREATE INDEX idx_sysequipo_servicio ON sysequipo(id_servicio_fk);
CREATE INDEX idx_sysequipo_activo ON sysequipo(activo);
CREATE INDEX idx_indequipo_servicio ON indequipo(id_servicio_fk);
CREATE INDEX idx_indequipo_activo ON indequipo(activo);
CREATE INDEX idx_llamado_estado ON llamado(estado);
CREATE INDEX idx_llamado_fecha ON llamado(fecha);
CREATE INDEX idx_mantenimiento_preventivo_realizado ON mantenimiento_preventivo(realizado);
CREATE INDEX idx_repuesto_activo ON repuesto(activo);
